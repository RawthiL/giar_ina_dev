...
class AlliumCepaConfig(BaseConfig):
    ...
    detection_weights_path: Path = (
        _ROOT / "src/allium_cepa_classifier/models/weights/object_detection_v1.pt"
    )
    classification_weights_path: Path = (
        _ROOT / "src/allium_cepa_classifier/models/weights/classifier_efficientNetB1_20E.pt"
    )
